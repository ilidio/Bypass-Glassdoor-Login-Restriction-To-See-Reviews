The extension bypasses Glassdoor's login restriction by making a simple modification to the website's url. To use it, the user should navigate to the following url:
